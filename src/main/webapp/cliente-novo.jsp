...
<html lang="en">
    <head>
        ...
        <link href="/crud-dwp/css/styles.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="/crud-dwp/cliente/lista">Lista</a>
									<a class="nav-link" href="/crud-dwp/cliente/novo">Novo</a></nav>
                            </div>
                            <!--
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="/crud-dwp/cliente/novo" method="post"><!-- caminho de destino do formulario -->
                                <input type="hidden" name="id" value="${id}">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
														<label class="small mb-1" for="nome">Nome</label>
														<input class="form-control" name="nome" value="${nome}" id="nome" type="text" placeholder="Nome Completo" />
													</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
												...
												<input class="form-control" name="email" value="${email}" id="email" type="email" aria-describedby="emailHelp" placeholder="Informe seu e-mail" /></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="cpf_cnpj">CPF/CNPJ</label>
													<input class="form-control" name="cpf_cnpj" value="${cpf_cnpj}" id="cpf_cnpj" type="text" placeholder="Informe seu cpf/cnpj" /></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="telefone">Telefone</label>
													<input class="form-control" name="telefone" value="${telefone}" id="telefone" type="text" placeholder="Informe seu telefone" /></div>
                                                </div>
                                            </div>
        ...
        <script src="/crud-dwp/assets/demo/datatables-demo.js"></script>
        <script type="text/javascript">
        	document.getElementById("btnLista").addEventListener("click", function(){
        		window.location.href = "/crud-dwp/cliente/lista";
        	})
        </script>
    </body>
</html>
